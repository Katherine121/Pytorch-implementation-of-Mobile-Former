...
if __name__ == '__main__':
    ...
    # Load ONNX model
    print('--> Loading model')
    ret = rknn.load_onnx(model='./tune_model/mobile_former_151.onnx')
    # ret = rknn.load_rknn('./tune_model/mobile_former_151.rknn')
    if ret != 0:
    ...
    ret = rknn.export_rknn('./tune_model/mobile_former_151.rknn')
    if ret != 0:
