...
from utils.config import config_151
...
if __name__ == "__main__":
    ...
    model_save_dir = './check_point/mobile_former_151_100.pth'
    ...
    cifar_val = torchvision.datasets.CIFAR100('./dataset/', train=True, download=True, transform=transform)
